...
- [next, authorization required] Prepare the Phase 4 production-integration candidate as source-only disposable work: wire the reviewed components behind injected real-adapter boundaries and prove reversible task migration/read-back/rollback without deployment or production execution.
- [deferred] Phase 4 production migration and Phase 5 cleanup. Controller authorization is required before any deployment or production action.
