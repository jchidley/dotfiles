Draft a detailed, step-by-step blueprint for building: $ARGUMENTS
...
If no project name provided in arguments, use the current directory name as project name.
Store the plan in ~/.claude/plans/[project-name]/plan_[timestamp].md
Also create TODO.md in the project directory to track implementation state.